      ...
      <div className="fixed inset-4 md:inset-8 z-40 glass rounded-2xl flex flex-col overflow-hidden animate-slide-up">
        ...
        <div className="flex items-start justify-between px-6 py-4 border-b border-surface-border shrink-0">
          <div className="space-y-1">
            <h2 className="text-xl font-bold text-white">{loading ? "Loading…" : pin?.title}</h2>
          ...
          <button onClick={onClose} className="text-zinc-500 hover:text-white transition-colors text-xl ml-4 shrink-0">✕</button>
        </div>
          ...
          {loading ? (
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-3">
                ...
                {canEdit && (
                  <form onSubmit={handleAddEntry} className="space-y-2 pt-1">
                    <textarea
                      value={entryText}
              ...
              {canEdit && (
                <div className="pt-2 border-t border-surface-border">
                  <button onClick={handleDelete}
                    className="text-xs text-red-400 hover:text-red-300 hover:bg-red-950/30 px-3 py-2 rounded-lg transition-colors">
                    🗑 Delete Pin
                  </button>
                </div>
              )}
